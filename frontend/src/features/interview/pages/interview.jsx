...
const Interview = () => {
    ...
    return (
        <div className='interview-page'>
            ...
            {/* ── Top Nav ── */}
            <nav className='interview-topnav'>
                <div className='interview-topnav__inner'>
                    <div className='interview-topnav__logo' onClick={() => navigate('/dashboard')}>
                    ...
                    <div className='interview-topnav__title'>
                        <h1>{report.title || 'Interview Strategy'}</h1>
                    </div>
                    <button className='button neutral-button' onClick={() => navigate('/dashboard')}>
